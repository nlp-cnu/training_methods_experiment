...
ALL_MODELS = [BIOCLINICAL_DISCHARGE_SUMMARY_BERT, BLUE_BERT_PUBMED, BLUE_BERT_PUBMED_MIMIC, BERTweet, BIO_REDDIT_BERT]


DOMAIN_SPECIFIC_MODELS = ALL_MODELS[1:]

EXP1_WINNING_MODELS = [BLUE_BERT_PUBMED_MIMIC, PUBMED_BERT, BLUE_BERT_PUBMED, PUBMED_BERT, PUBMED_BERT, PUBMED_BERT, PUBMED_BERT, BLUE_BERT_PUBMED, BIO_REDDIT_BERT]
EXP3B_MODELS = [BIO_REDDIT_BERT, PUBMED_BERT, PUBMED_BERT, PUBMED_BERT, PUBMED_BERT]
