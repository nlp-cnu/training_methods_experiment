...
ONTO_CLASS_MAP = {NONE_CLASS:0, "a":1, "b":2, "c":3, "d":4}
...
EXP1_WINNING_MODELS = [BLUE_BERT_PUBMED_MIMIC, BIOCLINICAL_DISCHARGE_SUMMARY_BERT, BLUE_BERT_PUBMED, BLUE_BERT_PUBMED, , BLUE_BERT_PUBMED, BLUE_BERT_PUBMED, , ]
