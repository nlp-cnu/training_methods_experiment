...
EXP3B_INTER = [ADEMINER_INTER_DATA, BC7MED_INTER_DATA]
...
EXP3B_MODELS = [PUBMED_BERT, BLUE_BERT_PUBMED] # [BIO_BERT, BLUE_BERT_PUBMED, BIOCLINICAL_DISCHARGE_SUMMARY_BERT]
