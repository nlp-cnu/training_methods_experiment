...
ALL_MODELS = [BASE_BERT, PUBMED_BERT, BLUE_BERT_PUBMED_MIMIC]
...
EXP3B_MODELS = [BASE_BERT] * 5  # [PUBMED_BERT, BLUE_BERT_PUBMED] # [BIO_BERT, BLUE_BERT_PUBMED, BIOCLINICAL_DISCHARGE_SUMMARY_BERT]
