...
EXP1_WINNING_MODELS = [BLUE_BERT_PUBMED_MIMIC, BIOCLINICAL_DISCHARGE_SUMMARY_BERT, BLUE_BERT_PUBMED, BLUE_BERT_PUBMED, "NONE", BLUE_BERT_PUBMED, BLUE_BERT_PUBMED, BIO_REDDIT_BERT, PUBMED_BERT]
