...
def convert_NLM():
    train_file = os.path.join("BC7T2-NLMChem-corpus-train.BioC.json")
    dev_file = os.path.join("BC7T2-NLMChem-corpus-dev.BioC.json")
    test_file = os.path.join("BC7T2-NLMChem-corpus-test.BioC.json")
