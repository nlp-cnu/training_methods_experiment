...
def convert_i2b2():
    train_data_dir_beth = os.path.join("i2b2_2010_training_data", 
            "concept_assertion_relation_training_data", "beth", "txt")
    train_ann_dir_beth = os.path.join("i2b2_2010_training_data", 
            "concept_assertion_relation_training_data", "beth", "concept")
    train_data_dir_partners = os.path.join("i2b2_2010_training_data", 
            "concept_assertion_relation_training_data", "partners", "txt")
    train_ann_dir_partners = os.path.join("i2b2_2010_training_data", 
            "concept_assertion_relation_training_data", "partners", "concept")
    test_data_dir = os.path.join("i2b2_2010_test_data", "test_data")
    test_ann_dir = os.path.join("i2b2_reference_standard", "reference_standard_for_test_data", "concepts")
