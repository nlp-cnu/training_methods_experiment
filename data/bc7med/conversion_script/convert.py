...
def convert_Med():
    train_file_a = os.path.join("BioCreative_TrainTask3.0.tsv")
    train_file_b = os.path.join("BioCreative_TrainTask3.1.tsv")
    dev_file = os.path.join("BioCreative_ValTask3.tsv")
    test_file = os.path.join("BioCreative_TEST_Task3_PARTICIPANTS.tsv")
